...
public class Main {
        ...
        while (true){
            ...
            switch (menuSelection){
                ...
                case 1: //List Products
                    try {
                        for (Product product : StaticConstants.PRODUCT_LIST){
                            System.out.println("com.company.Product Name: " + product.getName() + " com.company.Product Category Name: " + product.getCategoryName());
                        }
                    }catch (Exception e){
                        System.out.println("com.company.Product could not print because category not found for product name: " + e.getMessage().split(",")[1]);
                    }
                    break;
                ...
                case 5: //Place Order
                    ...
                    System.out.println("There are Discount options: Do you want to see and apply to your cart if applicable? for no discount type no");
                    for (Discount discount : DISCOUNT_LIST){
    ...
    private static String[] prepareMenuOptions(){
        return new String[]{"List Categories:","List Products:","List Discount","See Balance","Add Balance","Place Order","See com.company.Cart","Order Details","See com.company.Address","Close Application"};
    }
